...
**Note** - This is a fork of ACC[github.com/Akilesh-T/ACC] with KSU support,if you need magisk support use the original one
**Features**
...
* Systemless install using a KSU module.
